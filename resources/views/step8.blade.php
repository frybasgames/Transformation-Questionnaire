...
@section("content")
    <header>
        <div class="bgBanner" style="background-image: url(/img/Oost-timor.JPG);">
            <h3 class="bgBanner-first">koffiegurator uitslag</h3>
            <h2 class="bgBanner-second">Jouw ultieme koffie:</h2>
            <h2 class="bgBanner-third">Uganda Bugisu</h2>
            ...
            <section class="sectionOfLagarantaCoff">
                <aside>
                    <div class="pageImgParent">
                        ...
                        <a data-fancybox="gallery" data-src="/img/coff-uganda.png" class="resizeImg">
                ...
                <aside class="lagarantaCoffContent">
                    ...
                    <div>
                        <button onclick="submitLike('Bekijk Prijzen', '8')">Bekijk prijzen</button>
                    </div>
                </aside>
            </section>
        </main>
            ...
            <section>
                <aside class="mainOfLagarantaBG-aside1">
                    ...
                    <div class="mainOfLagarantaBG-aside1InnerDiv">
                        ...
                        <div>
                            <button onclick="submitLike('Ontdek meer', '8')">Lorem, ipsum dolor.</button>
                        </div>
                    </div>
                </aside>
            ...
            <aside>
                ...
                <div class="eachProduct">
                    ...
                    <div class="productInfo">
                        ...
                        <h5>
                            Unieke blend met tinten van anijs. Een smaaksensatie waar iedereen blij van wordt. </h5>
                        <button onclick="submitLike('Ontdek meer', '8')">Ontdek meer</button>
                    </div>
                </div>
                ...
                <div class="eachProduct">
                    <div class="productImgParent">
                        <img src="/img/coff-brazilie.png" alt="Coffee brasil" loading="lazy"/>
                    </div>
                    <div class="productInfo">
                        <h3>Yellow Bourbon</h3>
                        <h5>
                            Yellow Bourbon koffie bonen, meerdere jaren op rij winnaar van de Cup of Excellence
                            Brazillië.
