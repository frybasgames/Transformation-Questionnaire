...
@section("content")
    <header>
        <div class="bgBanner" style="background-image: url(/img/Oost-timor.JPG);">
            ...
            <h2 class="bgBanner-third">East Timor Lacau Village</h2>
            <h4 class="bgBanner-fourth">
                geroosterd brood, groene appel, sinaasappel en siroop
            </h4>
            ...
            <section class="sectionOfLagarantaCoff">
                <aside>
                    <div class="pageImgParent">
                        ...
                        <a data-fancybox="gallery" data-src="./img/Oost-timor.png" class="resizeImg">
                ...
                <aside class="lagarantaCoffContent">
                    ...
                    <div>
                        <button onclick="submitLike('Bekijk prijzen', '7')">Bekijk prijzen</button>
                    </div>
                </aside>
            </section>
        </main>
            ...
            <section>
                <aside class="mainOfLagarantaBG-aside1">
                    ...
                    <div class="mainOfLagarantaBG-aside1InnerDiv">
                        ...
                        <div>
                            <button onclick="submitLike('Lorem, ipsum dolor.', '7')">Lorem, ipsum dolor.</button>
                        </div>
                    </div>
                </aside>
            ...
            <aside>
                <div class="eachProduct">
                    ...
                    <div class="productInfo">
                        ...
                        <button onclick="submitLike('Ontdek meer', '7')">Ontdek meer</button>
                    </div>
                </div>
                <div class="eachProduct">
                    <div class="productImgParent">
